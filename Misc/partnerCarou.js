...
function changeSlide(slide) {
    ...
    document.getElementById("partnerCarousel").style.left = "-" + (currentSlide * 258) + "px"
...
function detectDots() {
    ...
    var currentOnScreen = (Math.floor((window.innerWidth * (8/10))/ 258));
